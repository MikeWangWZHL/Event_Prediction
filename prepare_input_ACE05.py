...
def prepare_input(tempfile,event_type_dict,entity_type_dict,role_type_dict,tokenizer):
    ...
    for i in range(len(entity)-1):
        ...
        tokenized = tokenizer(first_sentence_instance,return_tensors='pt',max_length = 200 ,padding= 'max_length')
...
# prepare_input('ACE05_events_three_level_train.json',event_type_dict,entity_type_dict,role_type_dict,BertTokenizer.from_pretrained('bert-base-cased'))
