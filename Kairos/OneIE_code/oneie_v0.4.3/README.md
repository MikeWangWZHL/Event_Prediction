...
python preprocessing/process_ace.py -i <INPUT_DIR>/LDC2006T06/data -o <OUTPUT_DIR>
  -s resource/splits/ACE05-E -b <BERT_CACHE_DIR> -l english
```
...
- -b, --bert: Path to the BERT cache directory.
...
- Set the environment variable PYTHONPATH to the current directory.
  For example, if you unpack this package to `~/oneie_v0.4.3`, run:
  `export PYTHONPATH=~/oneie_v0.4.3`
