...
# print(configuration)
# quit()
pretrained_model_from_ACE = './model_save_ACE05_doc_time_order_pretrain_SpanBert_base_cased'
...
model = BertForSequenceClassification.from_pretrained(pretrained_model_from_ACE)
...
output_dir = './model_save_ACE05_Haoyang_4tuple_finetune_on_doctimeorder_spanBert_large/'
