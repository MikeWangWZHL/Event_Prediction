...
input_ids_train,attention_masks_train,role_type_ids_train,entity_type_ids_train,labels_train = prepare_input_withIBO_two_pair('ACE05_events_three_level_train_with_sent_id.json',event_type_dict,entity_type_dict,role_type_dict,tokenizer,tokenizer_max_len)

input_ids_dev,attention_masks_dev,role_type_ids_dev,entity_type_ids_dev,labels_dev = prepare_input_withIBO_two_pair('ACE05_events_three_level_dev_with_sent_id.json',event_type_dict,entity_type_dict,role_type_dict,tokenizer,tokenizer_max_len)
# input_ids_dev,attention_masks_dev,role_type_ids_dev,entity_type_ids_dev,labels_dev = prepare_input_withIBO_two_pair('test_temp_three_level.json',event_type_dict,entity_type_dict,role_type_dict,tokenizer,tokenizer_max_len)
...
# print(configuration)
# quit()
model = BertForSequenceClassification.from_pretrained(pretrained_model_name,config=configuration)
...
output_dir = './model_save_ACE05_doc_time_order_pretrain_SpanBert_large_cased/'
