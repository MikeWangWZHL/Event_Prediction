...
input_ids,attention_masks,role_type_ids,entity_type_ids,labels = prepare_input_withIBO_two_pair('ACE05_events_three_level_train_with_sent_id_new.json',event_type_dict,entity_type_dict,role_type_dict,tokenizer,tokenizer_max_len)

input_ids_test,attention_masks_test,role_type_ids_test,entity_type_ids_test,labels_test = prepare_input_withIBO_two_pair('ACE05_events_three_level_dev_with_sent_id_new.json',event_type_dict,entity_type_dict,role_type_dict,tokenizer,tokenizer_max_len)
...
# print(configuration)
# quit()
# pretrained_model_from_ACE = './model_save_ACE05_Haoyang_4tuple_finetune_on_doctimeorder_spanBert_base'
...
output_dir = './model_save_ACE05_Haoyang_4tuple_pretrain_with_trigger_role_embed_bert_base_9_8/'
